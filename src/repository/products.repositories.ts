...
export const createProduct = async (newProduct: Product) => {
  ...
  await pool
    ...
    .query(
      "INSERT INTO Products(productName, productBrand, productImage, stockQuantity, productDescription, productCategory, productPrice) VALUES (@productName, @productBrand, @productImage, @stockQuantity, @productDescription, @productCategory, @productPrice)",
    );
...
export const updateProduct = async (
  ...
  await pool
    ...
    .query(
      "UPDATE Products SET productName = @productName, productBrand = @productBrand, productImage = @productImage, stockQuantity = @stockQuantity, productDescription = @productDescription, productCategory = @productCategory, productPrice = @productPrice WHERE productId = @productId",
    );
